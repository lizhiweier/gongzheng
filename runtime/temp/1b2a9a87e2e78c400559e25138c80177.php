<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:70:"J:\code\gongzheng\public/../application/admin\view\auth\admin\add.html";i:1600139767;s:60:"J:\code\gongzheng\application\admin\view\layout\default.html";i:1588765311;s:57:"J:\code\gongzheng\application\admin\view\common\meta.html";i:1588765311;s:59:"J:\code\gongzheng\application\admin\view\common\script.html";i:1588765311;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="realname" class="control-label col-xs-12 col-sm-2">真实姓名:</label>
        <div class="col-xs-12 col-sm-8">
            <input type="realname" class="form-control" id="realname" name="row[realname]" value="" data-rule="required;chinese" />
        </div>
    </div>

    <div class="form-group">
        <label for="comname" class="control-label col-xs-12 col-sm-2">企业名称:</label>
        <div class="col-xs-12 col-sm-8">
            <input type="comname" class="form-control" id="comname" name="row[comname]" value="" data-rule="required" />
        </div>
    </div>

    <div class="form-group">
        <label for="phone" class="control-label col-xs-12 col-sm-2">手机号:</label>
        <div class="col-xs-12 col-sm-8">
            <input type="phone" class="form-control" id="phone" name="row[phone]" value="" data-rule="required;mobile" />
        </div>
    </div>
