                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <div class="input-group">
                                ...
                                <div class="input-group-addon no-border no-padding">
                                    <span>
                                        <button type="button" id="plupload-j_shenzheng" class="btn btn-danger plupload" data-input-id="c-j_shenzheng" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="false" data-maxsize="1M" data-preview-id="p-j_shenzheng">
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <div class="input-group">
                                ...
                                <div class="input-group-addon no-border no-padding">
                                    <span>
                                        <button type="button" id="plupload-j_shenfan" class="btn btn-danger plupload" data-input-id="c-j_shenfan" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="false" data-maxsize="1M" data-preview-id="p-j_shenfan">
                                            <i class="fa fa-upload"></i> 上传
                                        </button>
                                    </span>
                                </div>
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <div class="input-group">
                                ...
                                <div class="input-group-addon no-border no-padding">
                                    <span>
                                        <button type="button" id="plupload-j_license" class="btn btn-danger plupload" data-input-id="c-j_license" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="false" data-maxsize="1M" data-preview-id="p-j_license">
                                            <i class="fa fa-upload"></i> 上传
                                        </button>
                                    </span>
                                </div>
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <div class="input-group">
                                ...
                                <div class="input-group-addon no-border no-padding">
                                    <span>
                                        <button type="button" id="plupload-j_screenshots" class="btn btn-danger plupload" data-input-id="c-j_screenshots" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="false" data-maxsize="1M" data-preview-id="p-j_screenshots">
                                            <i class="fa fa-upload"></i> 上传
                                        </button>
                                    </span>
                                </div>
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <div class="input-group">
                                ...
                                <div class="input-group-addon no-border no-padding">
                                    <span>
                                        <button type="button" id="plupload-j_poweratt" class="btn btn-danger plupload" data-input-id="c-j_poweratt" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="false" data-maxsize="1M" data-preview-id="p-j_poweratt">
                                            <i class="fa fa-upload"></i> 上传
                                        </button>
                                    </span>
                                </div>
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <div class="input-group">
                                ...
                                <div class="input-group-addon no-border no-padding">
                                    <span>
                                        <button type="button" id="plupload-y_shenzheng" class="btn btn-danger plupload" data-input-id="c-y_shenzheng" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="false" data-maxsize="1M" data-preview-id="p-y_shenzheng">
                                            <i class="fa fa-upload"></i> 上传
                                        </button>
                                    </span>
                                </div>
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <div class="input-group">
                                ...
                                <div class="input-group-addon no-border no-padding">
                                    <span>
                                        <button type="button" id="plupload-y_shenfan" class="btn btn-danger plupload" data-input-id="c-y_shenfan" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="false" data-maxsize="1M" data-preview-id="p-y_shenfan">
                                            <i class="fa fa-upload"></i> 上传
                                        </button>
                                    </span>
                                </div>
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <div class="input-group">
                                ...
                                <div class="input-group-addon no-border no-padding">
                                    <span>
                                        <button type="button" id="plupload-y_license" class="btn btn-danger plupload" data-input-id="c-y_license" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="false" data-maxsize="1M" data-preview-id="p-y_license">
                                            <i class="fa fa-upload"></i> 上传
                                        </button>
                                    </span>
                                </div>
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <div class="input-group">
                                ...
                                <div class="input-group-addon no-border no-padding">
                                    <span>
                                        <button type="button" id="plupload-y_screenshots" class="btn btn-danger plupload" data-input-id="c-y_screenshots" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="false" data-maxsize="1M"  data-preview-id="p-y_screenshots">
                                            <i class="fa fa-upload"></i> 上传
                                        </button>
                                    </span>
                                </div>
                    ...
                    <div class="form-group form-group-lg">
                        ...
                        <div class="col-xs-12 col-sm-8">
                            <div class="input-group">
                                ...
                                <div class="input-group-addon no-border no-padding">
                                    <span>
                                        <button type="button" id="plupload-y_poweratt" class="btn btn-danger plupload" data-input-id="c-y_poweratt" data-mimetype="image/gif,image/jpeg,image/png,image/jpg,image/bmp" data-multiple="false" data-maxsize="1M" data-preview-id="p-y_poweratt">
                                            <i class="fa fa-upload"></i> 上传
                                        </button>
                                    </span>
                                </div>
